    ...
    public class EmployeeServiceTests
    {
        ...
        public void NotifyOfAbsence_EmployeeIsAbsent_OnEmployeeIsAbsentMustBeTriggered()
        {
            ...
            Assert.Raises<EmployeeIsAbsentEventArgs>(
               handler => employeeService.EmployeeIsAbsent += handler, // Attaches the Event Handler
               handler => employeeService.EmployeeIsAbsent -= handler, // Detaches the Event Handler
